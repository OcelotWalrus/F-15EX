...
var pylonSets = {
	...
	doubleagm154a: {name: "2 x AGM-154A", content: ["AGM-154A", "AGM-154A"], fireOrder: [0, 1], launcherDragArea: 0.0, launcherMass: 25, launcherJettisonable: 0, showLongTypeInsteadOfCount: 0, category: 3},
...
if (getprop("sim/model/f15/variant") == "EX") { # EX variant has different pylons and configuration than C and D variants
	...
	var pylon5set = [pylonSets.empty, pylonSets.podIrst, pylonSets.podEcm184, pylonSets.triplemk83, pylonSets.singlem84, pylonSets.triplecbu87, pylonSets.singlegbu31, pylonSets.singlegbu32, pylonSets.quadgbu39, pylonSets.singleagm84d, pylonSets.singleagm84e, pylonSets.singleagm154a, pylonSets.singleagm158a, pylonSets.singleagm158c];
...
fcs = fc.FireControl.new(pylons, [11,16,13,14,12,15,0,10,2,8,1,5,9,20,23,21,24,22,25,3,7,4,6], ["20mm Cannon","LAU-68C","AIM-9","AIM-9X","AIM-7","AIM-120","AIM-120D","MK-84", "GBU-10", "MK-82AIR", "MK-82", "MK-83", "CBU-87", "CBU-105", "AGM-65B", "GBU-12", "AGM-65D", "AGM-84D", "AGM-88E", "AGM-154A", "AGM-158A", "CATM-9X", "CATM-120D", "GBU-31", "GBU-32", "GBU-54", "AGM-158C", "GBU-39", "AGM-119A", "AGM-84E"]);
...
var getDLZ = func {
    if (fcs != nil and getprop("controls/armament/master-arm")) {
        ...
        if (w!=nil and w.parents[0] == armament.AIM) {
            ...
            if (result != nil and size(result) == 8 and result[4]<result[0]*1.5 and armament.contact != nil) {
...
var ag_standoff_jsow = func {
    if (fcs != nil and (!getprop("payload/armament/msg") or getprop("fdm/jsbsim/gear/unit[0]/WOW"))) {
        ...
        pylon2a.loadSet(pylonSets.aim9xw);
        pylon2b.loadSet(pylonSets.doubleagm154a);
        pylon2c.loadSet(pylonSets.aim9xw);
        ...
        pylon8a.loadSet(pylonSets.aim9xw);
        pylon8b.loadSet(pylonSets.doubleagm154a);
        pylon8c.loadSet(pylonSets.aim9xw);
		...
		setprop("payload/weight[12]/selected","Empty");
		setprop("payload/weight[1]/selected","2 x AGM-154A");
        setprop("payload/weight[5]/selected","Droptank");
        setprop("payload/weight[9]/selected","2 x AGM-154A");
		setprop("payload/weight[15]/selected","Empty");
...
var bore_loop = func {
    ...
    if (fcs != nil) {
        ...
        var hud_soi = getprop("sim/model/f15/avionics/SOI") == "HUD";

        # Slave the seeker to the bore at the HMD, if it's active
        if (aim != nil and (aim.type == "AIM-9X" or aim.type == "CATM-9X" or aim.type == "AGM-65B" or aim.type == "AGM-65D" or aim.type == "AGM-119A")) {

            if (hmd_slaving and aim.status < 1 and !hud_soi) {
        ...
        if (aim != nil and (aim.type == "AIM-9" or aim.type == "AIM-9X" or aim.type == "CATM-9X")) {
        	...
        	if (standby == 1 and !hmd_slaving and !hud_soi) {
                #aim.setBore(1);
                aim.setContacts(awg_9.completeList);
                aim.commandDir(0,-3.5);# the real is bored to -6 deg below real bore
                bore = 1;
            } elsif (!hmd_slaving and !hud_soi) {
