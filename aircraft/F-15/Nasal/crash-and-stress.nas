...
var crash_start = func {
	removelistener(lsnr);
	crashCode = CrashAndStress.new([0,1,2], {"weightLbs":55000, "maxG": 7.5, "minG": -5}, ["controls/flight/aileron", "controls/flight/elevator", "controls/flight/flaps"]);  # 55,000 lbs in Clean with CFTs.
	crashCode.start();
}
