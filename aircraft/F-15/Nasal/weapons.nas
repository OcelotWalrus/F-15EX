...
var ccrp = func {
    ...
    if (weap != nil and weap.parents[0] == armament.AIM and (weap.type == "MK-84" or weap.type == "GBU-10" or weap.type == "MK-82AIR" or weap.type == "MK-82" or weap.type == "MK-83" or weap.type == "CBU-87")) {
...
var armament_update = func {
    ...
    Count84.setValue(pylons.fcs.getAmmoOfType("MK-84")+pylons.fcs.getAmmoOfType("GBU-10")+pylons.fcs.getAmmoOfType("MK-82AIR")+pylons.fcs.getAmmoOfType("MK-82")+pylons.fcs.getAmmoOfType("MK-83")+pylons.fcs.getAmmoOfType("CBU-87"));
...
var get_sel_missile_count = func()
{
    ...
    {
        return pylons.fcs.getAmmoOfType("MK-84")+pylons.fcs.getAmmoOfType("GBU-10")+pylons.fcs.getAmmoOfType("MK-82AIR")+pylons.fcs.getAmmoOfType("MK-82")+pylons.fcs.getAmmoOfType("MK-83")+pylons.fcs.getAmmoOfType("CBU-87");
    }
...
var arm_selector = func() {
    ...
    if ( stick_s == 0 ) {
        ...
        var ground_wps = ["CBU-87", "MK-82AIR", "MK-82", "MK-83", "MK-84", "GBU-10"];
        var count = 5 - selector_offset;  # length of the list (id 1 is 0 here)
        if (count < 0) {
            var selector_offset = 0;
            setprop("controls/armament/selected-armament-offset", 0);
        }
