...
## These methods are used for compatible AGM missiles: AGM-65B, AGM-65D and AGM-84D
...
var seekerLoop = func {
    ...
    if (selectedWeap == nil) {
        seekerTimer.stop();
    } elsif ((selectedWeap.type == "AGM-65B" or selectedWeap.type == "AGM-65D" or selectedWeap.type == "AGM-84D") and (awg_9.active_u == nil or !awg_9.active_u.get_display())) {
        selectedWeap.commandDir(cursorX,cursorY);
    } elsif (awg_9.active_u != nil and awg_9.active_u.get_display() and (selectedWeap.type == "AGM-65B" or selectedWeap.type == "AGM-65D" or selectedWeap.type == "AGM-84D")) {  # If we have a valid radar target, slave the AGM's seeker to that
...
var mavUpdate = func {
    selectedWeap = pylons.fcs.getSelectedWeapon();
    if (selectedWeap == nil or (selectedWeap.type != "AGM-65B" and selectedWeap.type != "AGM-65D" and selectedWeap.type != "AGM-84D")) {
...
var lock = func {
    selectedWeap = pylons.fcs.getSelectedWeapon();
    if (selectedWeap != nil and ArmSwitch.getValue() > 0 and (selectedWeap.type == "AGM-65B" or selectedWeap.type == "AGM-65D" or selectedWeap.type == "AGM-84D")) {
...
var armament_update = func {
    ...
    Count84.setValue(pylons.fcs.getAmmoOfType("MK-84")+pylons.fcs.getAmmoOfType("GBU-10")+pylons.fcs.getAmmoOfType("MK-82AIR")+pylons.fcs.getAmmoOfType("MK-82")+pylons.fcs.getAmmoOfType("MK-83")+pylons.fcs.getAmmoOfType("CBU-87")+pylons.fcs.getAmmoOfType("CBU-105")+pylons.fcs.getAmmoOfType("AGM-65B")+pylons.fcs.getAmmoOfType("GBU-12")+pylons.fcs.getAmmoOfType("AGM-65D")+pylons.fcs.getAmmoOfType("AGM-84D"));
...
var arm_selector = func() {
    ...
    if ( stick_s == 0 ) {
        ...
        var ground_wps = ["CBU-87", "CBU-105", "MK-82AIR", "MK-82", "MK-83", "MK-84", "GBU-10", "GBU-12", "AGM-84D", "AGM-65B", "AGM-65D"];
        var count = 10 - selector_offset;  # length of the list (id 1 is 0 here)
        if (count < 0) {
            var selector_offset = 0;
            setprop("controls/armament/selected-armament-offset", 0);
        }
