...
# Adapted to the F-15 by Jimmy L. Miles
#
...
var FLIRCameraUpdater = {
    ...
    update: func (dt) {
        ...
        if (getprop("sim/model/f15/flir/target/auto-track") and me.click_coord_cam != nil) {
    ...
    _get_flir_updater: func (offset, updater) {
        return func (roll_deg, pitch_deg) {
            var yaw   = getprop("sim/model/f15/flir/input/yaw-deg") + (180.0 - offset);
            var pitch = getprop("sim/model/f15/flir/input/pitch-deg");
    ...
    _get_flir_auto_updater: func (yaw_offset) { # update_cam
        return func (aircraft_roll_deg, aircraft_pitch_deg, tgp_yaw_relative, tgp_pitch) {
            ...
            setprop("sim/model/f15/flir/target/yaw-deg", yaw);
            setprop("sim/model/f15/flir/target/pitch-deg", pitch);
...
setlistener("/sim/signals/fdm-initialized", func {
    setlistener("sim/model/f15/flir/target/view-enabled", func (node) {
...
var list = func (node) {
    ...
    if (button == 20) {#BACK
        ...
        #setprop("sim/model/f15/flir/target/auto-track", 0);
        #lock.hide();
...
#        }
    ...
    if (button == 1 or (getprop("controls/displays/cursor-click") and getprop("/sim/current-view/name") == "TGP")) {#LOCK
        ...
        if (lock_tgp) return;
        gps = 0;
        if (getprop("sim/model/f15/flir/target/auto-track")) {
            flir_updater.offsetP = 0;
...
var fast_loop = func {
  var viewName = getprop("/sim/current-view/name");
    ...
    if (viewName == "TGP" and (getprop("/fdm/jsbsim/gear/unit[0]/WOW") or !getprop("sim/model/f15/stores/tgp-mounted"))) {
    ...
    #    }
        ...
        # FLIR TGP stuff:
        setprop("sim/model/f15/flir/target/view-enabled", viewName == "TGP");
        ...
        if (enable) {
            lasercode = getprop("sim/model/f15/avionics/laser-code");
            if (getprop("sim/model/f15/flir/target/auto-track") and flir_updater.click_coord_cam != nil) {
            ...
            if (getprop("sim/model/f15/avionics/cara-on")) {
        ...
        if (!getprop("sim/model/f15/flir/target/auto-track") or flir_updater.click_coord_cam == nil) {
        ...
        #lock.hide();
        #setprop("sim/model/f15/avionics/lock-flir",0.05);
    }
    ...
    if (getprop("sim/model/f15/stores/tgp-mounted") and enable) {
        ...
        } elsif (getprop("sim/model/f15/flir/target/auto-track") and flir_updater.click_coord_cam != nil and steerlock) {
            midl.setText(sprintf("STPT %s  %s", "#"~steerpoints.getCurrentNumber(), getprop("controls/armament/laser-arm-dmd")?"L":""));
        } elsif (getprop("sim/model/f15/flir/target/auto-track") and flir_updater.click_coord_cam != nil) {
        ...
        var scaleLock = getprop("sim/model/f15/avionics/lock-flir");
        ...
        setprop("sim/model/f15/flir/swivel/pitch-deg",polarL);
        setprop("sim/model/f15/flir/swivel/roll-deg",polarD);
    } elsif (!masterMode) {
        lock.hide();
    }
    var dt = systime();
    if (viewName == "TGP" and getprop("sim/model/f15/stores/tgp-mounted") and enable) {
...
var midl = nil;
var ir = 1;
var lasercode = int(rand()*1778+1111);setprop("sim/model/f15/avionics/laser-code",lasercode);
var callsign = nil;
var lock_tgp = 0;
var lock_tgp_last = 0;
var wide = 1;
